...
export default function StreamRoom() {
  ...
  // Inyectar anuncio lateral manualmente para asegurar visibilidad
  useEffect(() => {
    if (!adPlaying && !adInjected.current) {
      const adContainer = document.getElementById('container-d9776db8a2d68a75a0f93175459f95a7');
      if (adContainer) {
  ...
  return (
    <div className="stream-container">
            ...
            {adPlaying && (
              <div className="mini-ad-box">
                ...
                <div className="ad-body">
                  ...
                  <small>Disfruta del stream en HD</small>
                </div>
              </div>
            )}
            <div data-vjs-player>
          ...
          <div className="video-footer">
            <div className="video-details">
              <div className="details-text">
                ...
                <p className="live-meta">Conectado vía Cloudflare Stream</p>
              </div>
              <div className="action-buttons">
                 <button className="btn-action reload" onClick={initStream}>🔄</button>
      ...
      <style jsx global>{`
        ...
        .mini-ad-box { position: absolute; top: 20px; right: 20px; width: 220px; background: #000; border: 1px solid var(--primary); border-radius: 12px; z-index: 100; box-shadow: 0 10px 30px rgba(0,0,0,0.8); overflow: hidden; }
        ...
        .ad-spinner { width: 20px; height: 20px; border: 2px solid #333; border-top-color: #fff; border-radius: 50%; animation: spin 1s linear infinite; margin: 0 auto 10px; }
